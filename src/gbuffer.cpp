...
GBuffer::GBuffer( unsigned int width, unsigned int height, int nTextures, int *textureTypes, GLuint baseTexUnit, GLFWwindow *window  )

{
 ...
 // Create the FBO
  ...
  for (int i = 0 ; i < numTextures; i++) {
    ...
    glTexImage2D( GL_TEXTURE_2D, 0, textureTypes[i], fbWidth, fbHeight, 0, GL_RED, GL_FLOAT, NULL );
...

{
  ...
  GLsizei width = (GLsizei) (size * fbWidth);
  GLsizei height = (GLsizei) (size * fbHeight);
